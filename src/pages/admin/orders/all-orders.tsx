                                                        ...
                                                        <tr key={order._id}>
                                                            ...
                                                            <td>
                                                                <div className="btn-group" role="group">
                                                                    <button type="button" className="btn btn-dark btn-sm dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
                                                                        Select Status <i className="mdi mdi-chevron-down"></i>
                                                                    </button>
                                                                    <ul className="dropdown-menu" >
                                                                        <li><a className="dropdown-item" href="#">Shipped</a></li>
                                                                        <li><a className="dropdown-item" href="#">Delivering</a></li>
                                                            ...
                                                            <td>
                                                                <Eye size={16} onClick={() => handleOpenModal(order)}
                                                                    style={{ cursor: 'pointer' }}
                                                                    className="me-3"
                                                                />

                                                                <SquarePen size={16} onClick={() => handleOpenModal(order)}
                                                                    style={{ cursor: 'pointer' }}
                                                                    className="me-3"
                                                                />

                                                                <Trash2 size={16} color="red" onClick={() => handleOpenModal(order)}
                                                                    style={{ cursor: 'pointer' }}
                                                                    className="me-3"
                                                                />
                                    ...
                                    <tbody>
                                        ...
                                        {selectedOrder.items.map((item: any, index: any) => (
                                            <tr className="item" key={index}>
                                                ...
                                                <td>₹{item.product?.price * item.quantity || '0.00'}</td>
                                            </tr>
                                        ))}
