                                    ...
                                    <div className="card-header">
                                        <div className="d-flex align-items-center">
                                            <div className="border border-dark rounded-2 me-2 widget-icons-sections">
                                                <i data-feather="minus-square" className="widgets-icons" />
                                            </div>
                                            <h5 className="card-title mb-0">Audiences By Time Of Day</h5>
                                        </div>
                                    </div>
                                    <div className="card-body">
                                            ...
                                            <table className="table table-traffic mb-0">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>82.54%</td>
                                                        <td className="w-25">
                                                            <div id="sparkline-bounce-1" className="apex-charts" />
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                        ...
                                                        <td>76.29%</td>
                                                        <td className="w-25">
                                                            <div id="sparkline-bounce-2" className="apex-charts" />
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                        ...
                                                        <td>72.68%</td>
                                                        <td className="w-25">
                                                            <div id="sparkline-bounce-3" className="apex-charts" />
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                        ...
                                                        <td>44.78%</td>
                                                        <td className="w-25">
                                                            <div id="sparkline-bounce-4" className="apex-charts" />
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                        ...
                                                        <td>41.15%</td>
                                                        <td className="w-25">
                                                            <div id="sparkline-bounce-5" className="apex-charts" />
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                        ...
                                                        <td>32.65%</td>
                                                        <td className="w-25">
                                                            <div id="sparkline-bounce-6" className="apex-charts" />
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                        ...
                                                        <td>32.65%</td>
                                                        <td className="w-25">
                                                            <div id="sparkline-bounce-7" className="apex-charts" />
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
